...
average_time = st.slider("3. On average, how many hours per week do you study outside of the classroom? st.markdown("**Disclaimer:** Please use the last 6 months of school as a reference."), 0, 25, 0)
